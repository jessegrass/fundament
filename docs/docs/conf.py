...
# clasic build configuration file
...
linkcheck_ignore = [
    ...
    r"https://github.com/collective/clasic/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/collective/clasic",
    ...
    "repository_url": "https://github.com/collective/clasic",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/collective/clasic/edit/main/docs/",
# }
...
ogp_site_name = "clasic Documentation"
ogp_type = "website"
...
htmlhelp_basename = "clasicDocumentation"
...
latex_documents = [
    (
        "index",
        "clasicDocumentation.tex",
        "clasic Documentation",
